...
Stock Synthesis (3.24u). The model begins in 1900, and assumes the stock
...
This stock assessment estimates that Lingcod in the base model are above
...
depletion level for \hl{Model 1} in 2014 is 73.4\%
(\textasciitilde{}95\% asymptotic interval: \(\pm\) 63.7\%-83.2\%,
...
3\_WA\_NorthernWA\_Rec\_PR: 0.9797 (0.6425\_2.215)
