...
0.005   0.50    0.14   -1.888         3  0.3333  6       0       0       0           0       0.5         0       0           #1 F_M_young
...
0.01    1.00    0.18      3.0        -1  0.8     3       0       0       0           0       0.5         0       0           #5 CV@LAAFIX
0.01    1.0     0.03      0.0        -1  1       4       0       0       0           0       0           0       0           # CV@LAAFIX2
#GP_1:::Male (Direct Estimation)
0.005   0.60    0.16   -1.580         3  0.3326  6       0       0       0           0       0.5         0       0           #1 M_M_young
10      45      16.3    17.18        -1  10      2       0       0       0           0       0.5         0       0           #2 M_L@Amin (Amin is age entered above)
35      80      42.8     58.7        -1  10      3       0       0       0           0       0.5         0       0           #3 M_L@Amax
...
0.1     10  2.944      3     -1      9   2  0   0   0   0   0    2   1   # Retain_2 Slope
0.001   1   0.9945     1     -1      9   4  0   0   0   0   0    2   1   # Retain_3 Asymptote
-10     10  0          0     -1      9  -2  0   0   0   0   0    0   0   # Retain_4 Male offset (additive)
#...DO_MALE (AS OFFSET) 
-15     15 -9          0     -1      5   3  0   0   0   0   0.5  0   0   #PEAK (see Selex24.xls)
-15     15 -1.2        0     -1      5   4  0   0   0   0   0.5  0   0   #ASC_WIDTH (see Selex24.xls)
...
-5      3   3.0      0.7     -1      5  -3  0   0   0   0   0.5  0   0   #TOP (see Selex24.xls)
-4      12  5.0      3.42    -1      5   2  0   0   0   0   0.5  0   0   #ASC_WIDTH (see Selex24.xls)
-2      15  14.0     0.21    -1      5  -3  0   0   0   0   0.5  0   0   #DSC_WIDTH (see Selex24.xls)
-15     5   -999     -8.9    -1      5  -4  0   0   0   0   0.5  0   0   #INIT (see Selex24.xls)
-5      5   -999     0.15    -1      5  -4  0   0   0   0   0.5  0   0   #FINAL (see Selex24.xls)
#RETENTION
10      40  30.100   15      -1      9   1  0   0   0   0   0    3   1   # Retain_1 Inflection
0.1     10  1.6790   3       -1      9   2  0   0   0   0   0    3   1   # Retain_2 Slope
0.001   1   0.9935   1       -1      9   4  0   0   0   0   0    3   1   # Retain_3 Asymptote
-10     10  0        0       -1      9  -2  0   0   0   0   0    0   0   # Retain_4 Male offset (additive)
#...DO_MALE (AS OFFSET)
-20     15  -11      0       -1     -5   3  0   0   0   0   0.5  0   0   #PEAK (see Selex24.xls)
-15     15  -1.8     0       -1     -5   4  0   0   0   0   0.5  0   0   #ASC_WIDTH (see Selex24.xls)
-15     15   0       0       -1      5  -4  0   0   0   0   0.5  0   0   #DSC_WIDTH (see Selex24.xls)
-15     15   0       0       -1      5  -4  0   0   0   0   0.5  0   0   #FINAL (see Selex24.xls)
-15     15   1       0       -1      5  -4  0   0   0   0   0.5  0   0   #APICAL SEL (see Selex24.xls)
...
#FEMALE
#LO     HI  INIT    PRIOR   PR_TYPE SD  PHASE   env-var use_dev dev_yr1 dev_yr2 dev_sd  nblks   blk_pat #
15      75  40.5116  43.1    -1      5   1  0   0   0   0   0.5  1   1   #PEAK (see Selex24.xls)
-5      3   3.0      0.7     -1      5  -3  0   0   0   0   0.5  0   0   #TOP (see Selex24.xls)
-4      12  4.3270   3.42    -1      5   2  0   0   0   0   0.5  0   0   #ASC_WIDTH (see Selex24.xls)
-2      15  14.0     0.21    -1      5  -3  0   0   0   0   0.5  0   0   #DSC_WIDTH (see Selex24.xls)
-15     5   -999     -8.9    -1      5  -4  0   0   0   0   0.5  0   0   #INIT (see Selex24.xls)
-5      5   -999     0.15    -1      5  -4  0   0   0   0   0.5  0   0   #FINAL (see Selex24.xls)
#RETENTION
10      40  28.716   15      -1      9   1  0   0   0   0   0    2   1   # Retain_1 Inflection
0.1     10  1.1843    3      -1      9   2  0   0   0   0   0    2   1   # Retain_2 Slope
0.001   1   0.969     1      -1      9   4  0   0   0   0   0    2   1   # Retain_3 Asymptote
-10     10  0         0      -1      9  -2  0   0   0   0   0    0   0   # Retain_4 Male offset (additive)
#...DO_MALE (AS OFFSET)
-15     15  -12.5284  0      -1      5   3  0   0   0   0   0.5  0   0   #PEAK (see Selex24.xls)
-15     15  -2.4191   0      -1      5   4  0   0   0   0   0.5  0   0   #ASC_WIDTH (see Selex24.xls)
-15     15   0        0      -1      5  -4  0   0   0   0   0.5  0   0   #DSC_WIDTH (see Selex24.xls)
-15     15   0        0      -1      5  -4  0   0   0   0   0.5  0   0   #FINAL (see Selex24.xls)
-15     15   1        0      -1      5  -4  0   0   0   0   0.5  0   0   #APICAL SEL (see Selex24.xls)
...
#FEMALE
#LO     HI  INIT    PRIOR   PR_TYPE SD  PHASE   env-var use_dev dev_yr1 dev_yr2 dev_sd  nblks   blk_pat #
15      75   41.0793 43.1    -1      5   1  0   0   0   0   0.5  1   1   #PEAK (see Selex24.xls)
-5      3    3.0     0.7     -1      5  -3  0   0   0   0   0.5  0   0   #TOP (see Selex24.xls)
-4      12   4.3917  3.42    -1      5   2  0   0   0   0   0.5  0   0   #ASC_WIDTH (see Selex24.xls)
-2      15   14.0    0.21    -1      5  -3  0   0   0   0   0.5  0   0   #DSC_WIDTH (see Selex24.xls)
-15     5   -999     -8.9    -1      5  -4  0   0   0   0   0.5  0   0   #INIT (see Selex24.xls)
-5      5   -999     0.15    -1      5  -4  0   0   0   0   0.5  0   0   #FINAL (see Selex24.xls)
#RETENTION
10      40   28.346   15     -1      9   1  0   0   0   0   0    3   1   # Retain_1 Inflection
0.1     10   1.16      3     -1      9   2  0   0   0   0   0    3   1   # Retain_2 Slope
0.001   1    0.9995    1     -1      9   4  0   0   0   0   0    3   1   # Retain_3 Asymptote
-10     10   0         0     -1      9  -2  0   0   0   0   0    0   0   # Retain_4 Male offset (additive)
#...DO_MALE (AS OFFSET)
-15     15  -8.2910    0     -1      5   3  0   0   0   0   0.5  0   0   #PEAK (see Selex24.xls)
...
#FEMALE
#LO     HI  INIT    PRIOR   PR_TYPE SD  PHASE   env-var use_dev dev_yr1 dev_yr2 dev_sd  nblks   blk_pat #
15      61  44.7077  43.1     -1     5   1  0   0   0   0   0.5  0   0   #PEAK (see Selex24.xls)
-5      3   3.0      0.7      -1     5  -2  0   0   0   0   0.5  0   0   #TOP (see Selex24.xls)
-4      12  5.2529   3.42     -1     5   1  0   0   0   0   0.5  0   0   #ASC_WIDTH (see Selex24.xls)
-2      15  14.0     0.21     -1     5  -2  0   0   0   0   0.5  0   0   #DSC_WIDTH (see Selex24.xls)
-15     5   -999    -8.9      -1     5  -4  0   0   0   0   0.5  0   0   #INIT (see Selex24.xls)
-5      5   -999     0.15     -1     5  -4  0   0   0   0   0.5  0   0   #FINAL (see Selex24.xls)
#...DO_MALE (AS OFFSET)
-15     15  -6.4484  0        -1     5   2  0   0   0   0   0.5  0   0   #PEAK (see Selex24.xls)
