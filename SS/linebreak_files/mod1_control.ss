...
1973 1982 1983 1992 1993 2002 2003 2010 2011 2014 # For selectivities of al
# l fleets
...
1   #_maturity_option:  1=length logistic; 2=age logistic; 3=read age-matur
# ity matrix by growth_pattern; 4=read age-fecundity  
#_placeholder for empirical age-maturity by growth pattern
3   #_First_Mature_Age
1   #_fecundity option:(1)eggs=Wt*(a+b*Wt);(2)eggs=a*L^b;(3)eggs=a*Wt^b
0   #hermaphrodite
1   #_parameter_offset_approach (1=none, 2= M, G, CV_G as offset from femal
# e-GP1, 3=like SS2 V1.x)
1   #_env/block/dev_adjust_method (1=standard; 2=with logistic trans to kee
# p within base parm bounds)

#_growth_parms
#GP_1_Female
#LO     HI      INIT    PRIOR   PR_type  SD      PHASE   env-var use_dev de
# v_minyr dev_maxyr dev_stddev  Block   Block_Fxn
0.005   0.50    0.14   -1.888         3  0.3333  6       0       0       0 
          0       0.5         0       0           #1 F_M_young
10      45      15.8    17.18        -1  10      2       0       0       0 
          0       0.5         0       0           #2 F_L@Amin (Amin is age 
# entered above)
35      80      54.4     58.7        -1  10      3       0       0       0 
          0       0.5         0       0           #3 F_L@Amax
0.04    0.5     0.13     0.13        -1  0.8     2       0       0       0 
          0       0.5         0       0           #4 F_VBK
0.01    1.00    0.18      3.0        -1  0.8     3       0       0       0 
          0       0.5         0       0           #5 CV@LAAFIX
0.01    1.0     0.03      0.0        -1  1       4       0       0       0 
          0       0           0       0           # CV@LAAFIX2
#GP_1:::Male (Direct Estimation)
0.005   0.60    0.16   -1.580         3  0.3326  6       0       0       0 
          0       0.5         0       0           #1 M_M_young
10      45      16.3    17.18        -1  10      2       0       0       0 
          0       0.5         0       0           #2 M_L@Amin (Amin is age 
# entered above)
35      80      42.8     58.7        -1  10      3       0       0       0 
          0       0.5         0       0           #3 M_L@Amax
0.04    0.5     0.20     0.13        -1  0.8     2       0       0       0 
          0       0.5         0       0           #4 M_VBK
0.01    1.00    0.14      3.0        -1  0.8     3       0       0       0 
          0       0.5         0       0           #5 M_CV@LAAFIX
0.01    1.0     0.05      0.0        -1  1       4       0       0       0 
          0       0           0       0           # M_CV@LAAFIX2
#LW_female
#LO     HI      INIT        PRIOR       PR_type SD  PHASE   env-var use_dev
#  dev_minyr dev_maxyr dev_stddev  Block   Block_Fxn
-3      3       2.08296E-06 2.08296E-06 0       0.8 -3      0       0      
 0         0   0.5 0   0   #WL_intercept_female    
1       5       3.473703    3.473703    0       0.8 -3      0       0      
 0         0   0.5 0   0   #WL_slope_female    
#Female_maturity
10      50      33.1        33.1        0       0.8 -3      0       0      
 0         0   0.5 0   0   #mat_intercept  #L50
-3      3       -0.743      -0.743      0       0.8 -3      0       0      
 0         0   0.5 0   0   #mat_slope  From Hannah et al 2002
#Fecundity___Assume_same_as_spawning_biomass        
-3      3       1           1           0       1   -3      0       0      
 0         0   0.5 0   0   #mat_intercept  #L50
-3      3       0           0           0       1   -3      0       0      
 0         0   0.5 0   0   #mat_slope  
#LW_Male        
-3      3       3.05E-06    3.05E-06    0       0.8 -3      0       0      
 0         0   0.5 0   0   #WL_intercept_male  
-3      5       3.360544    3.360544    0       0.8 -3      0       0      
 0         0   0.5 0   0   #WL_slope_slope_male    

#LO     HI      INIT    PRIOR   PR_type SD  PHASE   env-var use_dev dev_min
# yr dev_maxyr dev_stddev Block Block_Fxn
#Allocate_R_by_areas_x_gmorphs
0   1   1   0.2 0   9.8 -3  0   0   0   0   0.5 0   0   #frac to GP 1 in ar
# ea 1
...
-4  4   0     1      0       9.8 -3     0       0       0         0        
 0.5        0     0   #frac R in season 1 

#CohortGrowDev
#SS3 manual says it must be given a value of 1 and a negative phase
#LO HI  INIT  PRIOR  PR_type SD  PHASE  env-var use_dev dev_minyr dev_maxyr
#  dev_stddev Block Block_Fxn
0   1   1     1      -1      0   -4     0       0       0         0        
 0          0     0
...
5       20  9.7     9       -1      10     1      #Ln(R0)
0.2     1   0.89    0.8      0      0.09   5      #steepness(h)
...
2009    # last year of main recr_devs; forecast devs start in following yea
# r
1       #_recdev phase
1       # (0/1) to read 13 advanced options
1845    #_Cond 0 #_recdev_early_start (0=none; neg value makes relative to 
# recdev_start)
3       #_recdev_early_phase
0       #_Cond 0 #_forecast_recruitment phase (incl. late recr) (0 value re
# sets to maxphase+1)
...
2014    #_first_recent_yr_nobias_adj_in_MPDadj_in_MPD (-1 to override ramp 
# and set biasadj=1.0 for all estimated recdevs)
0.80    #max bias
...
# read overall start F value; overall phase; N detailed inputs to read for 
# Fmethod 2
...
1 #_Cond 0 #_If q has random component, then 0=read one parm for each fleet
...
#FEMALE
#LO     HI  INIT    PRIOR   PR_TYPE SD  PHASE   env-var use_dev dev_yr1 dev
# _yr2 dev_sd  nblks   blk_pat #
15      75  46.6    43.1     -1      5   1  0   0   0   0   0.5  1   1   #P
# EAK (see Selex24.xls)
-5      3   3.0      0.7     -1      5  -3  0   0   0   0   0.5  0   0   #T
# OP (see Selex24.xls)
-4      12  3.9     3.42     -1      5   2  0   0   0   0   0.5  0   0   #A
# SC_WIDTH (see Selex24.xls)
-2      15  14.0    0.21     -1      5  -3  0   0   0   0   0.5  0   0   #D
# SC_WIDTH (see Selex24.xls)
-15     5   -999    -8.9     -1      5  -4  0   0   0   0   0.5  0   0   #I
# NIT (see Selex24.xls)
-5      5   -999    0.15     -1      5  -4  0   0   0   0   0.5  0   0   #F
# INAL (see Selex24.xls)
#RETENTION 
10      40  26.47     15     -1      9   1  0   0   0   0   0    2   1   # 
# Retain_1 Inflection
0.1     10  2.944      3     -1      9   2  0   0   0   0   0    2   1   # 
# Retain_2 Slope
0.001   1   0.9945     1     -1      9   4  0   0   0   0   0    2   1   # 
# Retain_3 Asymptote
-10     10  0          0     -1      9  -2  0   0   0   0   0    0   0   # 
# Retain_4 Male offset (additive)
#...DO_MALE (AS OFFSET) 
-15     15 -9          0     -1      5   3  0   0   0   0   0.5  0   0   #P
# EAK (see Selex24.xls)
-15     15 -1.2        0     -1      5   4  0   0   0   0   0.5  0   0   #A
# SC_WIDTH (see Selex24.xls)
-15     15  0          0     -1      5  -4  0   0   0   0   0.5  0   0   #D
# SC_WIDTH (see Selex24.xls)
-15     15  0          0     -1      5  -4  0   0   0   0   0.5  0   0   #F
# INAL (see Selex24.xls)
-15     15  1          0     -1      5  -4  0   0   0   0   0.5  0   0   #A
# PICAL SEL (see Selex24.xls)
#Size_selectivity for FISHERY SUMMER N
#FEMALE
#LO     HI  INIT    PRIOR   PR_TYPE SD  PHASE   env-var use_dev dev_yr1 dev
# _yr2 dev_sd  nblks   blk_pat #
15      75  50       43.1    -1      5   1  0   0   0   0   0.5  1   1   #P
# EAK (see Selex24.xls)
-5      3   3.0      0.7     -1      5  -3  0   0   0   0   0.5  0   0   #T
# OP (see Selex24.xls)
-4      12  5.0      3.42    -1      5   2  0   0   0   0   0.5  0   0   #A
# SC_WIDTH (see Selex24.xls)
-2      15  14.0     0.21    -1      5  -3  0   0   0   0   0.5  0   0   #D
# SC_WIDTH (see Selex24.xls)
-15     5   -999     -8.9    -1      5  -4  0   0   0   0   0.5  0   0   #I
...
# INAL (see Selex24.xls)
#RETENTION
10      40  30.100   15      -1      9   1  0   0   0   0   0    3   1   # 
# Retain_1 Inflection
0.1     10  1.6790   3       -1      9   2  0   0   0   0   0    3   1   # 
# Retain_2 Slope
0.001   1   0.9935   1       -1      9   4  0   0   0   0   0    3   1   # 
# Retain_3 Asymptote
-10     10  0        0       -1      9  -2  0   0   0   0   0    0   0   # 
# Retain_4 Male offset (additive)
#...DO_MALE (AS OFFSET)
-20     15  -11      0       -1     -5   3  0   0   0   0   0.5  0   0   #P
# EAK (see Selex24.xls)
-15     15  -1.8     0       -1     -5   4  0   0   0   0   0.5  0   0   #A
# SC_WIDTH (see Selex24.xls)
-15     15   0       0       -1      5  -4  0   0   0   0   0.5  0   0   #D
# SC_WIDTH (see Selex24.xls)
-15     15   0       0       -1      5  -4  0   0   0   0   0.5  0   0   #F
...
#LO     HI  INIT    PRIOR   PR_TYPE SD  PHASE   env-var use_dev dev_yr1 dev
# _yr2 dev_sd  nblks   blk_pat #
15      75  40.5116  43.1    -1      5   1  0   0   0   0   0.5  1   1   #P
# EAK (see Selex24.xls)
-5      3   3.0      0.7     -1      5  -3  0   0   0   0   0.5  0   0   #T
# OP (see Selex24.xls)
-4      12  4.3270   3.42    -1      5   2  0   0   0   0   0.5  0   0   #A
# SC_WIDTH (see Selex24.xls)
-2      15  14.0     0.21    -1      5  -3  0   0   0   0   0.5  0   0   #D
# SC_WIDTH (see Selex24.xls)
-15     5   -999     -8.9    -1      5  -4  0   0   0   0   0.5  0   0   #I
...
# INAL (see Selex24.xls)
#RETENTION
10      40  28.716   15      -1      9   1  0   0   0   0   0    2   1   # 
# Retain_1 Inflection
0.1     10  1.1843    3      -1      9   2  0   0   0   0   0    2   1   # 
# Retain_2 Slope
0.001   1   0.969     1      -1      9   4  0   0   0   0   0    2   1   # 
# Retain_3 Asymptote
-10     10  0         0      -1      9  -2  0   0   0   0   0    0   0   # 
# Retain_4 Male offset (additive)
#...DO_MALE (AS OFFSET)
-15     15  -12.5284  0      -1      5   3  0   0   0   0   0.5  0   0   #P
# EAK (see Selex24.xls)
-15     15  -2.4191   0      -1      5   4  0   0   0   0   0.5  0   0   #A
# SC_WIDTH (see Selex24.xls)
-15     15   0        0      -1      5  -4  0   0   0   0   0.5  0   0   #D
# SC_WIDTH (see Selex24.xls)
-15     15   0        0      -1      5  -4  0   0   0   0   0.5  0   0   #F
...
#LO     HI  INIT    PRIOR   PR_TYPE SD  PHASE   env-var use_dev dev_yr1 dev
# _yr2 dev_sd  nblks   blk_pat #
15      75   41.0793 43.1    -1      5   1  0   0   0   0   0.5  1   1   #P
# EAK (see Selex24.xls)
-5      3    3.0     0.7     -1      5  -3  0   0   0   0   0.5  0   0   #T
# OP (see Selex24.xls)
-4      12   4.3917  3.42    -1      5   2  0   0   0   0   0.5  0   0   #A
# SC_WIDTH (see Selex24.xls)
-2      15   14.0    0.21    -1      5  -3  0   0   0   0   0.5  0   0   #D
# SC_WIDTH (see Selex24.xls)
-15     5   -999     -8.9    -1      5  -4  0   0   0   0   0.5  0   0   #I
...
# INAL (see Selex24.xls)
#RETENTION
10      40   28.346   15     -1      9   1  0   0   0   0   0    3   1   # 
# Retain_1 Inflection
0.1     10   1.16      3     -1      9   2  0   0   0   0   0    3   1   # 
# Retain_2 Slope
0.001   1    0.9995    1     -1      9   4  0   0   0   0   0    3   1   # 
# Retain_3 Asymptote
-10     10   0         0     -1      9  -2  0   0   0   0   0    0   0   # 
# Retain_4 Male offset (additive)
#...DO_MALE (AS OFFSET)
-15     15  -8.2910    0     -1      5   3  0   0   0   0   0.5  0   0   #P
# EAK (see Selex24.xls)
-15     15  -1.5100    0     -1      5   4  0   0   0   0   0.5  0   0   #A
# SC_WIDTH (see Selex24.xls)
-15     15   0         0     -1      5  -4  0   0   0   0   0.5  0   0   #D
# SC_WIDTH (see Selex24.xls)
-15     15   0         0     -1      5  -4  0   0   0   0   0.5  0   0   #F
...
#LO     HI  INIT    PRIOR   PR_TYPE SD  PHASE   env-var use_dev dev_yr1 dev
# _yr2 dev_sd  nblks   blk_pat #
15      61  35.4319   43.1   -1      5   1  0   0   0   0   0.5  0   0   #P
# EAK (see Selex24.xls)
-5      3   3.0       0.7    -1      5  -2  0   0   0   0   0.5  0   0   #T
# OP (see Selex24.xls)
-4      12  4.2436    3.42   -1      5   1  0   0   0   0   0.5  0   0   #A
# SC_WIDTH (see Selex24.xls)
-2      15  14.0      0.21   -1      5  -2  0   0   0   0   0.5  0   0   #D
# SC_WIDTH (see Selex24.xls)
-15     5   -999      -8.9   -1      5  -4  0   0   0   0   0.5  0   0   #I
# NIT (see Selex24.xls)
-5      5   -999      0.15   -1      5  -4  0   0   0   0   0.5  0   0   #F
# INAL (see Selex24.xls)
#...DO_MALE (AS OFFSET)
-15     15  -4.1823    0     -1      5   2  0   0   0   0   0.5  0   0   #P
# EAK (see Selex24.xls)
-15     15  -0.5322    0     -1      5   2  0   0   0   0   0.5  0   0   #A
# SC_WIDTH (see Selex24.xls)
-15     15   0         0     -1      5  -3  0   0   0   0   0.5  0   0   #D
# SC_WIDTH (see Selex24.xls)
-15     15   0         0     -1      5  -3  0   0   0   0   0.5  0   0   #F
# INAL (see Selex24.xls)
-15     15   1         0     -1      5  -4  0   0   0   0   0.5  0   0   #A
# PICAL SEL (see Selex24.xls)
...
#LO     HI  INIT    PRIOR   PR_TYPE SD  PHASE   env-var use_dev dev_yr1 dev
# _yr2 dev_sd  nblks   blk_pat #
15      61  38.3545  43.1    -1      5   1  0   0   0   0   0.5  0   0   #P
# EAK (see Selex24.xls)
-5      3   3.0      0.7     -1      5  -2  0   0   0   0   0.5  0   0   #T
# OP (see Selex24.xls)
-4      12  4.8335   3.42    -1      5   1  0   0   0   0   0.5  0   0   #A
# SC_WIDTH (see Selex24.xls)
-2      15  14.0     0.21    -1      5  -2  0   0   0   0   0.5  0   0   #D
# SC_WIDTH (see Selex24.xls)
-15     5   -999    -8.9     -1      5  -4  0   0   0   0   0.5  0   0   #I
...
# INAL (see Selex24.xls)
#...DO_MALE (AS OFFSET)
-15     15  -4.0542  0       -1      5   2  0   0   0   0   0.5  0   0   #P
# EAK (see Selex24.xls)
-15     15  -0.1367  0       -1      5   2  0   0   0   0   0.5  0   0   #A
# SC_WIDTH (see Selex24.xls)
-15     15   0       0       -1      5  -3  0   0   0   0   0.5  0   0   #D
# SC_WIDTH (see Selex24.xls)
-15     15   0       0       -1      5  -3  0   0   0   0   0.5  0   0   #F
...
#LO     HI  INIT    PRIOR   PR_TYPE SD  PHASE   env-var use_dev dev_yr1 dev
# _yr2 dev_sd  nblks   blk_pat #
15      61  44.7077  43.1     -1     5   1  0   0   0   0   0.5  0   0   #P
# EAK (see Selex24.xls)
-5      3   3.0      0.7      -1     5  -2  0   0   0   0   0.5  0   0   #T
# OP (see Selex24.xls)
-4      12  5.2529   3.42     -1     5   1  0   0   0   0   0.5  0   0   #A
# SC_WIDTH (see Selex24.xls)
-2      15  14.0     0.21     -1     5  -2  0   0   0   0   0.5  0   0   #D
# SC_WIDTH (see Selex24.xls)
-15     5   -999    -8.9      -1     5  -4  0   0   0   0   0.5  0   0   #I
...
# INAL (see Selex24.xls)
#...DO_MALE (AS OFFSET)
-15     15  -6.4484  0        -1     5   2  0   0   0   0   0.5  0   0   #P
# EAK (see Selex24.xls)
-15     15  -0.5892  0        -1     5   2  0   0   0   0   0.5  0   0   #A
# SC_WIDTH (see Selex24.xls)
-15     15   0       0        -1     5  -3  0   0   0   0   0.5  0   0   #D
# SC_WIDTH (see Selex24.xls)
-15     15   0       0        -1     5  -3  0   0   0   0   0.5  0   0   #F
...
7    1.6  1.64 1.4  1    1    0.22  #_mult_by_agecomp_N
...
# 1 1 -1 5 1 5 # selex type, len/age, year, N selex bins, Growth pattern, N
#  growth ages
# -5 16 27 38 46 # vector with selex std bin picks (-1 in first bin to self
# -generate)
