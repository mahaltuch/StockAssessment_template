...
# r)
 0 0 -10 0 -999 0
#  2014 2014 2004 2014 1876 2014 # after processing 
1 # Control rule method (1=catch=f(SSB) west coast; 2=F=f(SSB) ) 
0.25 # Control rule Biomass level for constant F (as frac of Bzero, e.g. 0.
...
2015  #FirstYear for caps and allocations (should be after years with fixed
#  inputs) 
...
2013 # Rebuilder:  first year catch could have been set to zero (Ydecl)(-1 
# to set to 1999)
...
#_Fleet:  WinterN SummerN WinterS SummerS TriEarly TriLate NWFSC
#  0.36657 0.396884 0.104569 0.131977 0 0 0
